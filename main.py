...
dataset = dataset.astype('float32') #COnvert values to float
 ...
 # La normalización es opcional pero recomendada para redes neuronales como certain
 # Las funciones de activación son sensibles a la magnitud de los números.
...
dataset = scaler.fit_transform(dataset)
 ...
 #No podemos usar una forma aleatoria de dividir el conjunto de datos en entrenar y probar como
 #la secuencia de eventos es importante para las series de tiempo.
 #Así que tomemos los primeros valores del 60 % para entrenar y el 1/3 restante para probar
